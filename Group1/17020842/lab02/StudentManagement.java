...
public class StudentManagement {
    ...
    public static void main(String[] args) {
        ...
        // in thông tin ra màn hình
        System.out.println(secondStudent.getInfor() + "\n\n" + thirdStudent.getInfor() + "\n\n" + fourthStudent.getInfor());
        System.out.println("firstStudent và secondStudent cùng lớp: " + StudentManagement1.sameGroup(firstStudent, secondStudent));
        System.out.println("thirdStudent và fourthStudent cùng lớp: " + StudentManagement1.sameGroup(thirdStudent, fourthStudent));
        //studentManagement.inputStudents(1);
        new StudentManagement().students[0] = new Student(firstStudent);
        System.out.println(studentManagement.students[0].getName());
        //System.out.println();
        //studentManagement.removeStudent("17020842");
        System.out.println(new StudentManagement().students[0].same(firstStudent, secondStudent));
        new StudentManagement().studentByGroup();

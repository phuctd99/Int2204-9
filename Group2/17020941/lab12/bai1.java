...
import java.util.ArrayList;
    ...
    public class bai1 {
        public static void main(String[] args) {
            person gen1 = new person("apple", "1/1/1988","Male", false);
            gen1.MarriedWith(new person("samsung", "1/1/1998", "Female", false));
            gen1.bornChild(new person("huawei", "1/1/2002", "Female", false));
            gen1.bornChild(new person("asus", "31/1/2005", "Male", false));
            gen1.children.get(0).MarriedWith(new person("a","24/5/2004", "Male", false));
            gen1.children.get(0).bornChild(new person("b", "25/6/2010", "Male", false));
            gen1.children.get(0).bornChild(new person("c", "29/9/2016", "Male", false));

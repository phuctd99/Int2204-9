...
public class main {
    ...
    public static void main(String[] args) {
        ...
        print(arr1);
        System.out.println("GTLN của mảng Integer: " + max(arr1));
        sort(arr1);
        ...
        System.out.print("Mảng chưa được sắp xếp: ");
        print(arr2);
        System.out.println("GTLN của mảng Double: " + max(arr2));
        sort(arr2);
        System.out.print("Mảng sau khi được sắp xếp: ");
        print(arr2);
        System.out.println();
        ...
        System.out.print("Mảng chưa được sắp xếp: ");
        print(arr3);
        System.out.println("GTLN của mảng Character: " + max(arr3));
        sort(arr3);
        System.out.print("Mảng sau khi được sắp xếp: ");
        print(arr3);
        System.out.println();
